...
template<typename ResType>
ReadOnlyHandle<ResType> make_read_only_handle(Handle<ResType> handle) {
...
struct TemporalResourceKey {
    ...
    struct Hash {
        size_t operator()(const TemporalResourceKey& key) const {
...
struct TemporalResourceState {
    ...
    Type type;
    std::variant<
        struct { TemporalResource resource; vk_sync::AccessType access_type; },
        struct { TemporalResource resource; ExportableGraphResource handle; },
        struct { TemporalResource resource; ExportedResourceHandle handle; }
    > data;
};
...
public:
    ...
    Handle<typename Desc::ResourceType> get_or_create_temporal(
...
// Get or create trait
template<typename Desc>
class GetOrCreateTemporal {
public:
    static Handle<typename Desc::ResourceType> get_or_create_temporal(
...
template<>
class GetOrCreateTemporal<ImageDesc> {
public:
    static Handle<ImageResource> get_or_create_temporal(
        TemporalRenderGraph& self,
        const TemporalResourceKey& key,
...
template<>
class GetOrCreateTemporal<BufferDesc> {
public:
    static Handle<BufferResource> get_or_create_temporal(
        TemporalRenderGraph& self,
        const TemporalResourceKey& key,
