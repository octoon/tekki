#include "tekki/renderer/bindless_descriptor_set.h"

namespace tekki::renderer {

VkDescriptorSet BindlessDescriptorSet::CreateBindlessDescriptorSet(VkDevice device, uint32_t maxBindlessDescriptorCount) {
    try {
