...
AccessInfo get_access_info(AccessType access_type) {
    ...
    switch (access_type) {
        ...
        case AccessType::IndirectBuffer:
            return { vk::PipelineStageFlagBits::eDrawIndirect, vk::AccessFlagBits::eIndirectCommandRead, vk::ImageLayout::eUndefined };
        ...
        case AccessType::VertexBuffer:
            return { vk::PipelineStageFlagBits::eVertexInput, vk::AccessFlagBits::eVertexAttributeRead, vk::ImageLayout::eUndefined };
        ...
        case AccessType::VertexShaderReadSampledImageOrUniformTexelBuffer:
            return { vk::PipelineStageFlagBits::eVertexShader, vk::AccessFlagBits::eShaderRead, vk::ImageLayout::eShaderReadOnlyOptimal };
        case AccessType::FragmentShaderReadUniformBuffer:
            return { vk::PipelineStageFlagBits::eFragmentShader, vk::AccessFlagBits::eUniformRead, vk::ImageLayout::eUndefined };
        case AccessType::FragmentShaderReadSampledImageOrUniformTexelBuffer:
            return { vk::PipelineStageFlagBits::eFragmentShader, vk::AccessFlagBits::eShaderRead, vk::ImageLayout::eShaderReadOnlyOptimal };
        case AccessType::ComputeShaderReadUniformBuffer:
            return { vk::PipelineStageFlagBits::eComputeShader, vk::AccessFlagBits::eUniformRead, vk::ImageLayout::eUndefined };
        case AccessType::ComputeShaderReadSampledImageOrUniformTexelBuffer:
            return { vk::PipelineStageFlagBits::eComputeShader, vk::AccessFlagBits::eShaderRead, vk::ImageLayout::eShaderReadOnlyOptimal };
        case AccessType::ColorAttachmentRead:
            return { vk::PipelineStageFlagBits::eColorAttachmentOutput, vk::AccessFlagBits::eColorAttachmentRead, vk::ImageLayout::eColorAttachmentOptimal };
        case AccessType::ColorAttachmentWrite:
            return { vk::PipelineStageFlagBits::eColorAttachmentOutput, vk::AccessFlagBits::eColorAttachmentWrite, vk::ImageLayout::eColorAttachmentOptimal };
        ...
        case AccessType::General:
            return { vk::PipelineStageFlagBits::eAllCommands, vk::AccessFlagBits::eMemoryRead | vk::AccessFlagBits::eMemoryWrite, vk::ImageLayout::eGeneral };
        default:
