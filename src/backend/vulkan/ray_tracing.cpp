...
std::shared_ptr<class Buffer> RayTracingPipeline::create_shader_binding_table(
    vk::Device device,
...
std::shared_ptr<AccelerationStructure> RayTracingBuilder::build_blas(
...
std::shared_ptr<AccelerationStructure> RayTracingBuilder::build_tlas(
    const class Device& device,
    const AccelerationStructureBuildInfo& build_info
) {
