...
vk::ImageView Image::create_view(vk::Device device, vk::ImageViewType view_type,
                                 vk::ImageSubresourceRange subresource_range, vk::ComponentMapping components) const
{
    vk::ImageViewCreateInfo view_info{.image = image_,
                                      .viewType = view_type,
                                      .format = desc_.format,
...
ImageView::ImageView(vk::ImageView view, vk::Device device) : view_(view), device_(device) {}
