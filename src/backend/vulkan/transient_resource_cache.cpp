...
TransientResourceCache::TransientResourceCache(const std::shared_ptr<class Device>& device) : device_(device) {}
...
std::shared_ptr<TransientBuffer> TransientResourceCache::get_or_create_buffer(const TransientBufferDesc& desc,
                                                                              const std::string& name)
{
    ...
    BufferDesc buffer_desc{
        .size = desc.size, .usage = desc.usage, .memory_location = MemoryLocation::GpuOnly, .alignment = std::nullopt};
...
std::shared_ptr<TransientImage> TransientResourceCache::get_or_create_image(const TransientImageDesc& desc,
                                                                            const std::string& name)
{
    ...
    // Create new image
    ImageDesc image_desc{.extent = desc.extent,
                         .format = desc.format,
                         .usage = desc.usage,
