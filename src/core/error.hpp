...
public:
    explicit TekkiError(const std::string& message)
...
public:
    explicit VulkanError(const std::string& message)
        : TekkiError("Vulkan error: " + message) {}
};
...
public:
    explicit ShaderError(const std::string& message)
        : TekkiError("Shader error: " + message) {}
};
...
public:
    explicit AssetError(const std::string& message)
        : TekkiError("Asset error: " + message) {}
};
...
public:
    explicit RenderGraphError(const std::string& message)
        : TekkiError("Render graph error: " + message) {}
};
