...
glm::vec3 Sky::AtmosphereDefault(const glm::vec3& wi, const glm::vec3& lightDir, const glm::vec3& lightColor) {
    //return Vec3::ZERO;
...
glm::vec3 Sky::IntegrateScattering(
...
constexpr std::array<glm::mat3, 6> Sky::CubeMapFaceRotations = {
