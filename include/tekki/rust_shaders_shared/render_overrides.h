...
/**
 * Render overrides structure for controlling material and rendering properties
 */
struct alignas(16) RenderOverrides {
     ...
     * Copy constructor
     */
    RenderOverrides(const RenderOverrides& other) = default;

    /**
     * Assignment operator
     */
    RenderOverrides& operator=(const RenderOverrides& other) = default;

    /**
     * Equality comparison operator
     */
    bool operator==(const RenderOverrides& other) const {
