...
public:
    ...
    virtual std::shared_ptr<tekki::backend::Image> Create(std::shared_ptr<tekki::backend::Device> device) = 0;
    virtual void Compute(std::shared_ptr<tekki::render_graph::Graph> renderGraph, std::shared_ptr<tekki::backend::Image> image) = 0;
};
...
public:
    ...
    std::shared_ptr<tekki::backend::Image> Create(std::shared_ptr<tekki::backend::Device> device) override {
    ...
    void Compute(std::shared_ptr<tekki::render_graph::Graph> renderGraph, std::shared_ptr<tekki::backend::Image> image) override {
