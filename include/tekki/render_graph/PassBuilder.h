...
public:
    ...
    Ref<Res, ViewType> write_impl(Handle<Res>* handle, vk_sync::AccessType access_type,
                                  PassResourceAccessSyncType sync_type);

    template <typename Res> Ref<Res, GpuUav> write(Handle<Res>* handle, vk_sync::AccessType access_type);

    template <typename Res> Ref<Res, GpuUav> write_no_sync(Handle<Res>* handle, vk_sync::AccessType access_type);

    template <typename Res> Ref<Res, GpuRt> raster(Handle<Res>* handle, vk_sync::AccessType access_type);

    // Read operations
    template <typename Res> Ref<Res, GpuSrv> read(const Handle<Res>* handle, vk_sync::AccessType access_type);

    template <typename Res> Ref<Res, GpuRt> raster_read(const Handle<Res>* handle, vk_sync::AccessType access_type);
