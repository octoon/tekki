...
template <> struct ResourceTraits<Buffer>
{
...
template <> struct ResourceTraits<RayTracingAcceleration>
{
    struct DescType
    {
...
// Specializations
template <> struct ResourceDescTraits<ImageDesc>
{
    using ResourceType = Image;
};

template <> struct ResourceDescTraits<BufferDesc>
{
